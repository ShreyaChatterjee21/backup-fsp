...
public class NewEntry extends javax.swing.JFrame {
    ...
    public void DatabaseConn() {
        try {
            ...
            try {
                ...
                System.out.println("Server Connected"); // Print a message when successfully connected
    ...
    void addData() {
        ...
        String query = "INSERT INTO information(name,department, roll, semester) VALUES (?, ?, ?, ?)";
        try {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\khush\\Downloads\\4.gif")); // NOI18N
